...
|---|---|
| `name` | Film title |
| `description` | Plot summary (used as input) |
...
| Section | Feature Set | Model |
|---|---|---|
| 8.1.1 | Specific BoW | Logistic Regression |
| 8.1.2 | General BoW | Logistic Regression |
| 8.1.3 | Word Embeddings | Logistic Regression |
| 8.2.1 | Specific BoW | Neural Network (MLP) |
| 8.2.2 | General BoW | Neural Network (MLP) |
| 8.2.3 | Word Embeddings | Neural Network (MLP) |
| 8.3 | Word Embeddings | Optimized MLP (deeper architecture) |
| 8.4.1 | Word Embeddings | Logistic Regression (class-balanced) |
| 8.4.2 | Word Embeddings | L1-regularized Logistic Regression (class-balanced) |
...
```bash
pip install pandas numpy scikit-learn spacy transformers torch matplotlib seaborn
